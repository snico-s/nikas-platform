...
import { ExpenseForm, ExpenseFormSchema } from "./expense-form"

async function postExpense(data: ExpenseFormSchema) {
...
export function AddExpense({ currencies, categories, lastExpense }: Props) {
